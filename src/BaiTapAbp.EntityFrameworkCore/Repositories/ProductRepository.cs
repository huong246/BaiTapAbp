...
public class ProductRepository(IDbContextProvider<BaiTapAbpBusinessDbContext> dbContextProvider)
    : BaiTapAbpBusinessBaseRepository<ProductEntity, int>(dbContextProvider), IProductRepository
{
