...
public class ShopRepository(IDbContextProvider<BaiTapAbpBusinessDbContext> dbContextProvider) : BaiTapAbpBusinessBaseRepository<ShopEntity, int>(dbContextProvider), IShopRepository
{
